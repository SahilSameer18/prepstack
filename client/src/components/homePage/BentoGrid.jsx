  ...
  return (
    <section className="my-24">
      ...
      <div className="grid md:grid-cols-3 gap-5">
        ...
        <div className="md:col-span-2 rounded-2xl bg-[#0e0e0e] border border-white/[0.08] p-5 sm:p-8 flex flex-col justify-between hover:border-white/[0.18] transition-all group">
          <div>
            ...
            <div className="grid grid-cols-3 gap-2 sm:gap-3 max-w-md pt-2">
              <div className="bg-white/[0.02] border border-emerald-500/20 rounded-xl p-2 sm:p-3 text-center">
                <div className="text-[10px] sm:text-xs font-mono text-emerald-400 font-bold uppercase">
                  Easy
                </div>
              ...
              <div className="bg-white/[0.02] border border-amber-500/20 rounded-xl p-2 sm:p-3 text-center">
                <div className="text-[10px] sm:text-xs font-mono text-amber-400 font-bold uppercase">
                  Medium
                </div>
                <div className="text-xs sm:text-base font-bold text-white mt-0.5">
                  <span className="sm:hidden">Core</span>
                  <span className="hidden sm:inline">Interview Core</span>
                </div>
              </div>
              <div className="bg-white/[0.02] border border-rose-500/20 rounded-xl p-2 sm:p-3 text-center">
                <div className="text-[10px] sm:text-xs font-mono text-rose-400 font-bold uppercase">
                  Hard
                </div>
                <div className="text-xs sm:text-base font-bold text-white mt-0.5">
                  <span className="sm:hidden">FAANG</span>
                  <span className="hidden sm:inline">FAANG Bar</span>
                </div>
              </div>
            </div>
          </div>
        ...
        <div className="rounded-2xl bg-[#0e0e0e] border border-white/[0.08] p-5 sm:p-8 flex flex-col justify-between hover:border-white/[0.18] transition-all group">
          <div>
            <div className="flex items-center justify-between mb-4">
              <span className="font-mono text-xs text-[#ffa116] uppercase tracking-wider">
                02 · AI ARCHITECT
            ...
            <div className="bg-[#080808] border border-white/[0.06] rounded-xl p-3 font-mono text-[11px] sm:text-xs text-gray-400 break-words leading-relaxed">
