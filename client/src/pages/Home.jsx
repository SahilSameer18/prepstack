...
const FEATURES = [
  { title: "DSA Sheets", desc: "Curated problem sheets from Love Babbar, Striver, and NeetCode.", icon: FaCode, link: "/dsa", color: "from-orange-500 to-yellow-500", bg: "bg-orange-500/10", textColor: "text-orange-400" },
  { title: "Core CS Notes", desc: "Easy-to-understand notes for OS, DBMS, OOPs, and Computer Networks.", icon: FaBook, link: "/notes", color: "from-blue-500 to-cyan-500", bg: "bg-blue-500/10", textColor: "text-blue-400" },
  { title: "Roadmaps", desc: "Step-by-step learning paths for different tech stacks and developer roles.", icon: FaMap, link: "/roadmaps", color: "from-purple-500 to-pink-500", bg: "bg-purple-500/10", textColor: "text-purple-400" },
  { title: "AI Project Ideas", desc: "Generate unique project ideas tailored to your skills and tech stack.", icon: FaLightbulb, link: "/ai-projects", color: "from-green-500 to-emerald-500", bg: "bg-green-500/10", textColor: "text-green-400" },
  { title: "Behavioral Questions", desc: "Prepare for HR rounds with common behavioral interview questions.", icon: FaUserTie, link: "/behavioral", color: "from-pink-500 to-red-500", bg: "bg-pink-500/10", textColor: "text-pink-400" },
  { title: "Resume Guide", desc: "Learn how to craft a strong resume that stands out for SDE roles.", icon: FaFileAlt, link: "/resume", color: "from-indigo-500 to-purple-500", bg: "bg-indigo-500/10", textColor: "text-indigo-400" },
  { title: "Quiz", desc: "Test your knowledge with quick quizzes on DSA and core CS subjects.", icon: FaQuestionCircle, link: "/quiz", color: "from-yellow-500 to-orange-500", bg: "bg-yellow-500/10", textColor: "text-yellow-400" },
  { title: "Aptitude", desc: "Practice quantitative aptitude questions commonly asked in placements.", icon: FaCalculator, link: "/aptitude", color: "from-teal-500 to-green-500", bg: "bg-teal-500/10", textColor: "text-teal-400" },
];
          ...
          {STATS.map((s) => {
            ...
            return (
              <div key={s.label} className="bg-white/[0.03] border border-white/[0.06] rounded-2xl p-4 backdrop-blur-sm">
                <div className="text-[#ffa116] mb-1"><Icon /></div>
            ...
            {WHY_US.map((item) => {
              ...
              return (
                <div key={item.title} className="bg-[#141414] border border-white/[0.06] rounded-xl p-4 hover:border-white/[0.14] hover:bg-[#1a1a1a] transition-all duration-300">
                  <div className="text-[#ffa116] text-lg mb-2"><Icon /></div>
